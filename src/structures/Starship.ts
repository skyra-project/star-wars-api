...
export default class Starship {
	@Field(() => Int, { description: 'The maximum cargo capacity of this starship in kilograms' })
	...
	@Field(() => Int, { description: 'The cost of this starship, new, in galactic credits' })
	public costInCredits!: number;

	@Field(() => Int, { description: 'The number of personnel needed to run or pilot this starship' })
	public crew!: number;

	@Field(() => [Film], { description: 'The films this starship appeared in' })
	public films!: Film[];

	@Field(() => Int, { description: 'The class of hyperdrive this starship has' })
	...
	@Field(() => Int, { description: 'The number of non-essential people this starship can transport' })
