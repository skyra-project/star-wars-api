...
export default class AbilityResolver {
	...
	public getAbilityDetailsByFuzzy(
		@Args() { person: ability, skip, take, reverse }: AbilityPaginatedArgs,
	...
	public getAbilityDetailsByName(
		@Arg('ability', () => people) ability: string,
		@getRequestedFields() requestedFields: GraphQLSet<keyof AbilityEntry>
	): AbilityEntry {
	...
	public getAbilityByFuzzy(@Args() { person: ability, skip, take, reverse }: AbilityPaginatedArgs): Fuse.FuseResult<Pokemon.Ability>[] {
	...
	public getAbilityByName(@Arg('ability', () => people) ability: string): Pokemon.Ability {
